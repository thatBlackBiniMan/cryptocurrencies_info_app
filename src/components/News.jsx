...
const demoImage = 'http://coinevolution.com/wp-content/uploads/2020/06/cryptonews.jpg';
    ...
    <Col xs={24} sm={12} lg={8} key={1}>
     <card hoverable className="news-card">
      <a href={news.url} target="_blank" rel="noreferrer">
        ...
        <img style={{maxWidth:'200px', maxHeight: '100px'}} src={news?.image?.thumbnail?.contentUrl || demoImage} alt="images" />
        </div>
     <p>
